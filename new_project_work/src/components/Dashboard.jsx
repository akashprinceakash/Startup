    ...
    return (
        <>
            ...
            <header className='header'>
                {/* <div >!e</div> */}
                <div className='logo-container'> <img src="/public/gfxhead-coloured-22x.png" alt="" className="logo" /></div>
                <div className="auth" >
                    <button>Akash</button>
                    <button className="signup" onClick={()=> handlesignout()}>Logout</button>
