      ...
      {selectedMenu === "Profile Information" && (   
         <section className="personal-info">
          ...
          <section className="addresses">
            ...
            <div className="info-item">
             <div style={{width:'100%', border:'0.30px solid red', textAlign:'start'}}> <Button style={{color:"blue", backgroundColor:"white"}}>+ ADD A NEW ADDRESS</Button></div>
            </div>
            <div className="info-item">
             <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ipsa eaque dicta rerum dignissimos?</p>
            </div>
          </section>
          </section>
        )}
